    ...
    public class Node<T> where T : IComparable
    {
        ...
        public Node<T> Parent
        {
            ...
            set
            {
                if (Cycle())
                {
                    throw new TreeException("Cycles are not allowed!");
                }
                else
                {
                    this.parent = value;
        ...
        public T Value
        {
            ...
            set
            {
                ...
                {
                    throw new TreeException("Nulll-value is not allowed!");
                }
            }
        }
        ...
        public void Add(Node<T> node)
        {
            ...
            {
                throw new TreeException("Null nodes are not allowed!");
            }
        ...
        public void Add(T value)
        {
            ...
            {
                throw new TreeException("Null-value nodes are not allowed!");
            }
        }
        ...
        {
            if (this.Value.Equals(((Node<T>)obj).Value))
            {
                return false;
            }//по значению
            else if (this.ChildCount != ((Node<T>)obj).ChildCount)
            {
                return false; // по кол-ву потомков
            }
            else
            {
                for (int i = 0; i < ((Node<T>)obj).ChildCount; i++) // Equals потомки?
                {
                    if (!((Node<T>)obj).childNodes[i].Equals(this.childNodes[i]))
                    {
                        return false;
                    }
                }
